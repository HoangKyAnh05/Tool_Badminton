...
async function buildExecutiveReport() {
  ...
  const kpiItems = [
    ...
    ['9 VIDEO THỰC TẾ ĐƠN NAM & ĐÔI NAM', '6 Bài Đơn Nam + 3 Bài Đôi Nam, chống tua, tự động đổi theo ô sân', '100% Video thực tế'],
  ...
  t4.value = 'DANH MỤC 9 VIDEO THỰC CHIẾN & CÔNG NGHỆ GẮN LINK VIDEO';
  ...
  const videosData = [
    ...
    ["10", "TÍNH NĂNG MỞ RỘNG", "NÚT '➕ GẮN LINK VIDEO MỚI'", "Cho phép người dùng hoặc HLV tự dán link YouTube, YouTube Shorts hoặc MP4 online vào 4 chuyên mục.", "Link YouTube / Shorts / MP4 CDN", "KHÔNG GIỚI HẠN SỐ LƯỢNG, không tốn 1MB ổ cứng máy"]
  ];
